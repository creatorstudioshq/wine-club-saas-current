...
>(({
  ...
  return asChild ? (
    ...
    <div ref={ref as React.Ref<HTMLDivElement>} {...labelProps} />
  );
});
...
>(({
  ...
  return asChild ? (
    <Slot ref={ref} {...groupActionProps} />
  ) : (
    <button ref={ref as React.Ref<HTMLButtonElement>} {...groupActionProps} />
  );
});
...
>(({
  ...
  return asChild ? (
    ...
    <button ref={ref as React.Ref<HTMLButtonElement>} {...actionProps} />
  );
});
...
>(({
  ...
  return asChild ? (
    <Slot ref={ref} {...subButtonProps} />
  ) : (
    <a ref={ref as React.Ref<HTMLAnchorElement>} {...subButtonProps} />
  );
});
